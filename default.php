        ...
        <div class="row d-flex flex-column justify-content-between">
          ...
          <button>
            <form action="log-reg.php" method="POST">
              <button name="create-serial-def" type="submit" class="btn btn-pink ml-auto">
                <div>SUBSCRIBE <strong style="font-size:20px;">5$</strong> Per/Month</div>
              </button>
            </form>
          </button>
